 ...
 */
    ...
    $klenar_audio_url = function_exists( 'get_field' ) ? get_field( 'fromate_style' ) : NULL;
...
?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'ablog ablog-4 mb-55 format-audio' );?>>
            <?php if ( has_post_thumbnail() ): ?>    
                <div class="ablog__img ablog__img4 ablog__audio embed-responsive embed-responsive-16by9">
                    <?php if ( !empty( $klenar_audio_url ) ): ?>
                        <?php echo wp_oembed_get( $klenar_audio_url ); ?>
                    <?php endif;?>
                </div>
