...
Class Latest_posts_sidebar_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-latest-posts', 'Klenar Sidebar Posts Image', array(
			'description'	=> 'Latest Post Widget by Klenar'
		));
	}
					...
					?>
			            <div class="sidebar--widget__post mb-20">
			                ...
			                <div class="sidebar__post--thumb">
			                    <a href="<?php the_permalink(); ?>"><div class="post__img" data-background="<?php print esc_url(get_the_post_thumbnail_url(get_the_ID(),'full')); ?>"></div></a>
			                </div>
			                <?php endif; ?>
			                <div class="sidebar__post--text">
			                    <h6 class="sidebar__post--title"><a href="<?php the_permalink(); ?>"><?php print wp_trim_words(get_the_title(), 6, ''); ?></a></h6>
