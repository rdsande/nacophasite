...
class Heading extends BDevs_El_Widget
{
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('title', 'class', 'tp-section-title-two mb-20 bdevs-el-title');
        ?>
    ...
    ?>
        <?php if ($settings['title']) : ?>
            ...
            <?php if ($settings['sub_title']) : ?>
                <h5 class="tp-section-subtitle-three mb-20 bdevs-el-subtitle"><?php echo bdevs_element_kses_intermediate($settings['sub_title']); ?></h5>
                <?php endif; ?>
