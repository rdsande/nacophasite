...
class Pricing_Table extends BDevs_El_Widget
{
    ...
    protected function register_content_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __('Get Service', 'bdevselement'),
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('sub_title', 'class', 'price_sub_title');
        ...
        <div class="tp-pricing-two position-relative text-center bg-gray-light" data-wow-delay=".7s">
            ...
            <div class="price__badge <?php echo esc_attr($settings['badge_position']); ?>">
            ...
            <div class="tp-pricing-two-content">
                <div class="tp-pricing-two-rate <?php print esc_attr($class_name); ?>">
                    <h3><span><?php echo esc_html($currency); ?></span><?php echo bdevs_element_kses_basic($settings['price']); ?></h3>
                ...
                <h4 class="tp-pricing-cat"><?php echo bdevs_element_kses_basic($settings['title']); ?></h4>
                <?php endif; ?>

                <?php if ($settings['button_text']) : ?>
                <div class="tp-pricing-two-btn mb-30">
                    <a href="<?php echo esc_url($settings['button_link']); ?>" class="theme-btn"> 
                ...
                <div class="tp-pricing-two-list pb-50">
                    ...
                    <h4><?php echo bdevs_element_kses_basic($settings['features_title']); ?></h4>
                    <?php endif; ?>
                    <ul>
    ...
    <?php else:
        ...
        <div class="tp-pricing grey-bg text-center mb-30 <?php print esc_attr($class_name); ?> wow flipInY" data-wow-delay=".2s">
            <?php if ($settings['show_badge']) : ?>
            <div class="price__badge <?php echo esc_attr($settings['badge_position']); ?>">
               <h4><?php $this->print_render_attribute_string('badge_text'); ?><?php echo esc_html($settings['badge_text']); ?></h4>
            </div>
            ...
            <div class="tp-pricing-rate">
                <div class="tp-pricing-rate-inner text-center">
                    <?php if (!empty($settings['title'])) : ?>
                        <h4 class="tp-pricing-rate-subtitle mb-30">
                            <?php echo bdevs_element_kses_basic($settings['title']); ?>
                        </h4>
                    <?php endif; ?>
                    <h2 class="tp-pricing-rate-title mb-45"><span><?php echo esc_html($currency); ?></span><?php echo bdevs_element_kses_basic($settings['price']); ?></h2>
            ...
            <div class="tp-pricing-btn">
                <a href="<?php echo esc_url($settings['button_link']); ?>" class="theme-btn"><i class="flaticon-enter"></i> 
                    <?php echo esc_html($settings['button_text']); ?>
                </a>
            </div>
            <?php endif; ?>
