...
class Project extends BDevs_El_Widget {
    ...
    protected function render() {
        ...
        <?php else: 
            $this->add_render_attribute( 'title', 'class', 'tp-project-three-img-overlay-title' );
            $image = wp_get_attachment_image_url($settings['image']['id'], $settings['thumbnail_size']);
        ?>
            
            <div class="tp-project-three">
                <div class="tp-project-three-img">
                    <?php if (!empty($image)) : ?>
                    <img src="<?php echo esc_url($image); ?>" class="img" alt="img-not-found">
                    <?php endif; ?>
                    <div class="tp-project-three-img-overlay">
                       <div class="tp-project-three-img-overlay-text">
                            ...
                            <div class="tp-project-three-img-overlay-text-icon">
                                <a href="<?php echo esc_url($image); ?>" class="popup-image"><i class="fal fa-plus"></i></a>
                            </div>
                            <?php endif; ?>
