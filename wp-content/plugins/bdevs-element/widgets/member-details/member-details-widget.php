...
class Member_Details extends BDevs_El_Widget
{
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('title', 'class', 'tp-section-title text-white bdevs-el-title');

        if (!empty($settings['photo']['url'])) {
            $photo = wp_get_attachment_image_url($settings['photo']['id'], $settings['thumbnail_size']);
            if ( ! $photo ) {
                $photo = $settings['photo']['url'];
            } 
        } 
        ...
        <section class="tp-team-area">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="tp-team-bg theme-dark-bg bdevs-el-content">
                            <div class="tp-team fix">
                                <?php if (!empty($photo)) : ?>
                                <div class="tp-team-img">
                                    <img src="<?php echo esc_url($photo); ?>" class="img-fluid" alt="img not found">
                                </div>
                                <?php endif; ?>
                                <div class="tp-team-text pt-30 fix">
                                    ...
                                    <h4 class="tp-team-subtitle mb-25 bdevs-el-subtitle"><?php echo bdevs_element_kses_basic($settings['job_title']); ?></h4>
                                    <?php endif; ?>
                                    ...
                                    <ul class="pb-20">
                                        <?php foreach ($settings['info_list'] as $key => $slide):
                                            if (!empty($slide['image']['id'])){
                                                $slide_image = wp_get_attachment_image_url($slide['image']['id'], $settings['full']);
                                            }
                                        ?>
                                        <li>
                                            <a href="<?php echo $slide['title_url']; ?>">
