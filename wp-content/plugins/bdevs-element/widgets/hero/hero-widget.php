...
class Hero extends BDevs_El_Widget {
    ...
    protected function render() {
        ...
        <?php else:
        $this->add_inline_editing_attributes( 'title', 'basic' );
        $this->add_render_attribute( 'title', 'class', 'hero-title wow fadeInUp2 bdevs-el-title' );
        ...
        if ( !empty($settings['button_link']) ) {
            $this->add_render_attribute( 'button', 'class', 'z-btn z-btn-border wow fadeInUp2 bdevs-el-btn' );
        ...
        <section class="hero__area p-relative pt-100 pb-100">
            <div class="hero__item d-flex align-items-center">
                <div class="container">
                    <div class="row justify-content-centers">
                        <div class="col-xl-9 col-lg-7 d-flex align-items-center">
                            <div class="hero__content text-centers bdevs-el-content">
                                <?php if ( $settings['subtitle'] ) : ?>
                                    <span class="wow fadeInUp2 bdevs-el-subtitle" data-wow-delay=".2s"><?php echo bdevs_element_kses_intermediate( $settings['subtitle'] ); ?></span>
                                <?php endif; ?>
                                ...
                                ?>
                                <?php if ( $settings['description'] ) : ?>
                                    <div class="wow fadeInUp2" data-wow-delay=".6s">
                                        <p><?php echo bdevs_element_kses_intermediate( $settings['description'] ); ?></p>
                                    </div>
                                <?php endif; ?>
