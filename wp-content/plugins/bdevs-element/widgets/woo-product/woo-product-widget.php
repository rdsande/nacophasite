...
class Woo_Product extends BDevs_El_Widget
{
    ...
    <?php else: ?>
        ...
        <div class="featured-area">
            <div class="container">
                <div class="featured-actives owl-carousels row">
                	<?php foreach ($posts as $key => $post): ?>
                    
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product-wrapper mb-40 bdevs-el-content">
	                            <div class="product__box">
	                                <div class="pro-img mb-20">
	                                    <a href="<?php echo esc_url(get_the_permalink($post->ID)); ?>">
	                                       <?php echo get_the_post_thumbnail($post->ID, 'zibber-pro-thumb', ['class' => 'img-fluid opacity_1']); ?>
	                                    </a>
	                                    <div class="product-action text-center">
	                                ...
	                                <div class="pro-text">
	                                    ...
	                                    <h5 class="pro-price bdevs-el-subtitle"><?php echo \BdevsElement\BDevs_El_Woocommerce::product_price($post->ID, true); ?></h5>
	                                    </div>
	                                </div>
	                            </div>
                            </div>
