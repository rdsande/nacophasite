                        ...
                        <div class="col-xl-12">
                            <div class="mb-60">
                                <div class="tp-prjects-tab-menu masonary-menu d-flex justify-content-center">
                                    <?php foreach ( $filter_list as $list ): ?>
                                        <?php if ( $i === 1 ): $i++; ?>
                                        <button class="nav-link active" data-filter="*"><?php echo esc_html( 'All' ); ?></button>
                                        <button class="nav-link" data-filter=".<?php echo esc_attr( $list->slug ); ?>"><?php echo esc_html( $list->name ); ?></button>
                                        <?php else: ?>
                                        <button class="nav-link" data-filter=".<?php echo esc_attr( $list->slug ); ?>"><?php echo esc_html( $list->name ); ?></button>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                        ...
                        <div class="col-lg-4 col-md-6 grid-item <?php echo $item_classes; ?>">
                            <div class="tp-project z-index mb-30">
                                ...
                                <div class="tp-project-img">
                                    <img src="<?php echo get_the_post_thumbnail_url(); ?>" class="img-fluid" alt="img not found">
                                </div>
                                <?php endif; ?>
